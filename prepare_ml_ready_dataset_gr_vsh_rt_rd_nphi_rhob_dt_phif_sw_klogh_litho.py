...
# Save the ML-ready dataset (includes facies label and one-hot encoded lithology)
output_filename = 'ML_ready_GR, VSH, RT, RD, NPHI, RHOB, DT, PHIF, SW, KLOGH, facies, litho.csv'
